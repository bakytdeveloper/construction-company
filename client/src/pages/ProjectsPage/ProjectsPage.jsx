...
// // //             const resultsSection = document.querySelector('.pp-results');
...
// // //             });
// // //
// // //             // ... остальной код для availableTypes и т.д.
// // //
// // //         } catch (error) {
// // //             console.error('Error fetching data:', error);
// // //         } finally {
...
// // //
// // //
// // //     // В ProjectsPage.jsx, обновите applyFilters функцию с дебагом
// // //     const applyFilters = () => {
...
// // //             console.log('Тип complex ID:', typeof filters.complex);
// // //
// // //             filtered = filtered.filter(prop => {
// // //                 // Получаем ID ЖК из объекта
// // //                 const complexId = prop.residentialComplex?._id || prop.residentialComplex;
// // //                 console.log(`Объект "${prop.title}" - complexId:`, complexId, 'сравниваем с:', filters.complex);
...
// // //                                                 onClick={() => setFilters({...filters, complex: 'all'})}
// // //                                             >
// // //                                                 ✕
// // //                                             </button>
// // //                                         </div>
...
// //         }
// //         if (newFilters.complex && newFilters.complex !== 'all') {
// //             params.set('complex', newFilters.complex);
// //         }
...
// //             setComplexes(allComplexes);
// //
// //             // Собираем доступные опции для фильтров
// //             const typesSet = new Set();
// //             const statusesSet = new Set();
// //             const complexesSet = new Set();
// //
...
// //                 if (prop.propertyType) typesSet.add(prop.propertyType);
// //                 if (prop.status) statusesSet.add(prop.status);
// //                 if (prop.residentialComplex?._id || prop.residentialComplex) {
// //                     const complexId = prop.residentialComplex?._id || prop.residentialComplex;
...
// //                                         <select
// //                                             value={filters.complex}
// //                                             onChange={(e) => handleFilterChange({...filters, complex: e.target.value})}
// //                                             className="pp-select"
// //                                         >
// //                                             {availableComplexes.map(complex => (
// //                                                 <option key={complex._id} value={complex._id}>
...
// //                                                 key={status.id}
// //                                                 className={`pp-status-btn ${getStatusClass(status.id)} ${filters.status === status.id ? 'pp-active' : ''}`}
// //                                                 onClick={() => handleFilterChange({...filters, status: status.id})}
// //                                             >
// //                                                 {status.name}
// //                                             </button>
// //                                         ))}
