...
//                             Строим дома вашей мечты в Алматы с 2012 года.
...
//                         <h4>Услуги</h4>
//                         <ul className="footer-links">
//                             <li><Link to="/services/houses">Строительство домов</Link></li>
//                             <li><Link to="/services/apartments">Продажа квартир</Link></li>
//                             <li><Link to="/services/commercial">Коммерческая недвижимость</Link></li>
//                             <li><Link to="/services/renovation">Ремонт и отделка</Link></li>
//                         </ul>
//                     </div>
//
            ...
            <div className="container">
                <div className="footer-top">
                    ...
                    <div className="footer-section" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <ul className="footer-links">
                            <li><Link to="/projects?type=apartment">Квартиры</Link></li>
                            <li><Link to="/projects?type=house">Частные дома</Link></li>
                            <li><Link to="/projects?type=commercial">Коммерческая</Link></li>
                            <li><Link to="/projects?type=parking">Парковки</Link></li>
                            <li><Link to="/projects?type=storage">Кладовые</Link></li>
                        </ul>
                    </div>
