...
//     };
//
// // Функция для получения стилей контейнера (дополнительные inline стили при необходимости)
//     const getContentStyles = (position) => {
//         const baseStyles = {};
//
//         // Для SEO - добавляем data-атрибут для поисковых систем
//         return baseStyles;
//     };
//
//
